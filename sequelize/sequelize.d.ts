declare module 'sequelize' {
    class Sequelize {
        ...
        define(daoName: string, attributes: any, options?: any): SequelizeJS.Model;
        ...
        transaction(options?: any): Promise<SequelizeJS.Transaction>;
    }

    export = Sequelize;
}

declare module SequelizeJS {
    interface Model {
        sync(): any;
        drop(options?: any): any;
        ...
        findOne(options?: any, queryOptions?: any): Promise<Instance>;
        ...
        hasMany(model: Model, options?: any): any;
        belongsTo(model: Model, options?: any): any;
    }
    ...
    interface Instance {
        ...
        save(fields?: any, options?: any): Promise<Instance>;
